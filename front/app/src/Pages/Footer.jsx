...
import bgphone from '../img/footerphone.png'
...
const Footer = () => {
  ...
  const CustomNavigation = (path) => {
    ...
    const protectedRoutes = ['/shop', '/cart']
  ...
  return (
    <div>
      <footer className='relative w-full'>
        ...
        {/* ------ ДЕСКТОПНАЯ ВЕРСИЯ (полностью без изменений) ------ */}
        <div className='hidden md:flex absolute justify-between items-start z-10 top-[10rem] left-[4rem] right-[4rem]'>
          {/* Левый блок */}
        ...
        {/* ------ МОБИЛЬНАЯ ВЕРСИЯ (с абсолютным фоном) ------ */}
        <div className='md:hidden relative'>
          ...
          <div className="relative z-10 flex flex-col items-center pt-16 pb-8 px-3">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-[-60%] flex items-center">
            ...
            {/* Навигация */}
            <div className="flex flex-wrap justify-center gap-x-3 text-sm font-sf text-gray-300 mb-6 -translate-y-[30%]">
            ...
            <div className='w-full max-w-xs text-center'>
              <h3 className='text-[#8B1E1E] font-sf text-xl mb-2 text-center font-bold ml-3 -translate-y-[-25%]'>Контакты:</h3>
              <div className='flex flex-col text-sm text-[#0A0A0A] items-center -translate-y-[-5%]'>
                ...
                <div className='flex items-center gap-2'>
                  ...
                  <span>+72211891054</span>
                </div>
                <div className='flex items-center gap-2'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#8B1E1E">
                    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.084.534 4.045 1.472 5.76l-.985 3.648 3.648-.985A11.969 11.969 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 3.5a8.5 8.5 0 1 1 0 17 8.5 8.5 0 0 1 0-17z"/>
                    <path d="M12 6.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11z"/>
                  </svg>
                  <span>@bautavenicecarnival</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Копирайт: десктоп (без изменений) */}
        <div className='hidden md:block bg-[#0A0A0A] absolute bottom-[-2.8rem] py-[0.5rem] left-0 right-0 text-center text-[#C5A059] font-sf text-[1.2rem]'>
          © 2026 Баута. Все права защищены
        </div>
        {/* Копирайт: мобильный (без изменений) */}
        <div className='md:hidden bg-[#0A0A0A] text-center text-[#C5A059] font-sf text-[0.6rem] py-2'>
          © 2026 Баута. Все права защищены
        </div>
      </footer>
    </div>
